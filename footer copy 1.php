    ...
    <div class="container">
        <div class="d-lg-flex flex-wrap justify-content-lg-between align-items-center">
            ...
            <ul class="list-unstyled ps-0 px-lg-3 mb-0 d-flex flex-wrap order-lg-2">
                ...
                <li>
                    <a href="mailto:<?= the_field('email', 'option') ?>" target="_blank" rel="noopener noreferrer"
                        class="text-uppercase"><?= the_field('email', 'option') ?></a>
                </li>
                <?php endif; ?>
                <?php if (get_field('phone', 'option')) : ?>
                <li>
                    <a href="tel:<?= the_field('phone', 'option') ?>" target="_blank" rel="noopener noreferrer"
                        class="text-uppercase"><?= the_field('phone', 'option') ?></a>
                </li>
                <?php endif; ?>

                <?php if (get_field('facebook', 'option')) : ?>
                <li>
                    <a href="<?= the_field('facebook', 'option') ?>" target="_blank" rel="noopener noreferrer"
                        class="text-uppercase">FACEBOOK</a>
                </li>
                <?php endif; ?>

                <?php if (get_field('instagram', 'option')) : ?>
                <li>
                    <a href="<?= the_field('instagram', 'option') ?>" target="_blank" rel="noopener noreferrer"
                        class="text-uppercase">INSTAGRAM</a>
                </li>
                <?php endif; ?>
                <li>
